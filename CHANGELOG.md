...
- 发布 Roleplay 套件 0.1.7 并对齐 DSH `0.1.2-alpha.3`：更新精确兼容门禁、全部 DSH 依赖和公开 lockfile，把归档级联测试迁移到第一方 JSONL Session persistence，并重新生成 Typert Remote 产物；Prompt 顺序与 Settings 注册继续使用当前服务 API。
